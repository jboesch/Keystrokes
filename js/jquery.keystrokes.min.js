...
return data_stack;},_removeKeyListeners:function(name){var $elem=$(this),stack=$elem.data('stack'),stack_len=stack.length;while(stack_len--){if(stack[stack_len]._namespace===name){stack.splice(stack_len,1);}};$elem.data('stack',stack);},_keydown:function(event,elem){var $elem=$(elem),self=this,temp_keys_down=$elem.data('keys_down');if(!this.global.captureInputFields){if(!this._inputsBound){$(this.global.inputs).bind({"focusin.Keystrokes":function(e){self._clearKeysString(elem);},"focusout.Keystrokes":function(e){self._clearKeysString(elem);}});this._inputsBound=true;}
return;}
